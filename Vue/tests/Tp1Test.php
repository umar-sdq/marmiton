...
require_once __DIR__ . '/../Modele/Type.php';
require_once __DIR__ . '/../Modele/Utilisateur.php';

// Inclure les contrôleurs
require_once __DIR__ . '/../Controleur/ControleurAdminRecettes.php';
require_once __DIR__ . '/../Controleur/ControleurAdminIngredients.php';
require_once __DIR__ . '/../Controleur/ControleurRecettes.php';

// Inclure quelques vues
// (on testera par inclusion directe avec ob_start / ob_get_clean)
...
class ProjetTest extends TestCase
{
    ...
    {
        unset($_SESSION['user']); // pas connecté
        ob_start();
